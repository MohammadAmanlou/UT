...
00003a8b <shmctl>:
SYSCALL(shmctl)
    3a8b:	b8 23 00 00 00       	mov    $0x23,%eax
    3a90:	cd 40                	int    $0x40
    3a92:	c3                   	ret    
