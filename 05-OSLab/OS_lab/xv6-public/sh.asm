...
00000e9b <shmctl>:
SYSCALL(shmctl)
     e9b:	b8 23 00 00 00       	mov    $0x23,%eax
     ea0:	cd 40                	int    $0x40
     ea2:	c3                   	ret    
