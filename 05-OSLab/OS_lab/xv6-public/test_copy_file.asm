...
int main(int argc, char *argv[]) 
{
  ...
  1d:	74 2e                	je     4d <main+0x4d>
    {
        if(argc < 3)
  1f:	83 f8 02             	cmp    $0x2,%eax
  22:	7e 16                	jle    3a <main+0x3a>
        printf(2, "Error: you didn't enter 2 files!\n");
        else if(argc > 3)
            printf(2,"Error: Too many arguments!\n");
  24:	50                   	push   %eax
  25:	50                   	push   %eax
  26:	68 0a 08 00 00       	push   $0x80a
  2b:	6a 02                	push   $0x2
  2d:	e8 4e 04 00 00       	call   480 <printf>
  32:	83 c4 10             	add    $0x10,%esp
    exit();
  35:	e8 a9 02 00 00       	call   2e3 <exit>
        printf(2, "Error: you didn't enter 2 files!\n");
  3a:	50                   	push   %eax
  3b:	50                   	push   %eax
  3c:	68 e8 07 00 00       	push   $0x7e8
  41:	6a 02                	push   $0x2
  43:	e8 38 04 00 00       	call   480 <printf>
  48:	83 c4 10             	add    $0x10,%esp
  4b:	eb e8                	jmp    35 <main+0x35>
    }
  ...
  4d:	51                   	push   %ecx
  4e:	51                   	push   %ecx
  4f:	ff 72 08             	pushl  0x8(%edx)
  52:	ff 72 04             	pushl  0x4(%edx)
  55:	e8 39 03 00 00       	call   393 <copy_file>
	if (a== -1){
  5a:	83 c4 10             	add    $0x10,%esp
  5d:	83 c0 01             	add    $0x1,%eax
  60:	75 d3                	jne    35 <main+0x35>
		printf(2,"Error: File already exists!\n");
  62:	50                   	push   %eax
  63:	50                   	push   %eax
  64:	68 26 08 00 00       	push   $0x826
  69:	6a 02                	push   $0x2
  6b:	e8 10 04 00 00       	call   480 <printf>
  70:	83 c4 10             	add    $0x10,%esp
  73:	eb c0                	jmp    35 <main+0x35>
  75:	66 90                	xchg   %ax,%ax
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	eb 1a                	jmp    620 <printf+0x1a0>
          s = "(null)";
 606:	bb 43 08 00 00       	mov    $0x843,%ebx
        while(*s != 0){
