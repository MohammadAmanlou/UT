...
public interface CPYListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CPYParser#specQualifierLst}.
	 * @param ctx the parse tree
	 */
	void enterSpecQualifierLst(CPYParser.SpecQualifierLstContext ctx);
	/**
	 * Exit a parse tree produced by {@link CPYParser#specQualifierLst}.
	 * @param ctx the parse tree
	 */
	void exitSpecQualifierLst(CPYParser.SpecQualifierLstContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link CPYParser#compound}.
	 * @param ctx the parse tree
	 */
	void enterCompound(CPYParser.CompoundContext ctx);
	/**
	 * Exit a parse tree produced by {@link CPYParser#compound}.
	 * @param ctx the parse tree
	 */
	void exitCompound(CPYParser.CompoundContext ctx);
	/**
