...
public class OrderHandlerCreditCheckRollbackTest {
        ...
        void new_order_from_buyer_with_not_enough_credit_based_on_trades() {
                ...
                orderHandler.handleEnterOrder(
                                EnterOrderRq.createNewOrderRq(1, security.getIsin(), 200, LocalDateTime.now(), Side.BUY,
                                                100, 550, broker3.getBrokerId(), shareholder.getShareholderId(), 0, 0));
        ...
        void new_order_from_buyer_with_not_enough_credit_based_on_trades_with_iceberg_orders() {
                ...
                orderHandler.handleEnterOrder(EnterOrderRq.createNewOrderRq(1, security.getIsin(), 200,
                                LocalDateTime.now(),
        ...
        void update_order_from_buyer_with_not_enough_credit_based_on_trades_with_iceberg_orders() {
                ...
                orderHandler.handleEnterOrder(EnterOrderRq.createUpdateOrderRq(1, security.getIsin(), 4,
                                LocalDateTime.now(),
                                Side.BUY, 60, 1545, broker3.getBrokerId(), shareholder.getShareholderId(), 0, 0));
                ...
                verify(eventPublisher)
                                .publish(new OrderRejectedEvent(1, 4, List.of(Message.BUYER_HAS_NOT_ENOUGH_CREDIT)));
        }
}
