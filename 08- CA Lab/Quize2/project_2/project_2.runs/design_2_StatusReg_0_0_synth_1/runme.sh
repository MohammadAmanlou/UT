...
HD_PWD='C:/Users/ariya/OneDrive/Desktop/project_1/project_1/project_1.runs/design_2_StatusReg_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_StatusReg_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_StatusReg_0_0.tcl
