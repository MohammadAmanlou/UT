...
HD_PWD='C:/Users/ariya/ARM/ARM.runs/design_2_Val2Gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_Val2Gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_Val2Gen_0_0.tcl
