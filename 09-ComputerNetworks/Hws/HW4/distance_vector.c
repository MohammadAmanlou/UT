...
void rtupdate0(struct rtpkt *p); void rtupdate1(struct rtpkt *p);
void rtupdate2(struct rtpkt *p); void rtupdate3(struct rtpkt *p);
void linkhandler0(int linkid, int newcost); void linkhandler1(int linkid, int newcost);
void linkhandler2(int linkid, int newcost); void linkhandler3(int linkid, int newcost);
